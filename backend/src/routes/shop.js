...
/**
 * Public download of a demo's build, one route per slot:
 *   /demos/:id/apk   Android     /demos/:id/ipa   iOS
 * Both count towards the demo's download total, which is per demo rather than
 * per build.
 */
